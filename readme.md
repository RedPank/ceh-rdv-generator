...
Для указания пути до конфигурационного файла можно использовать опция "-c имя_файла" при запуске программы 
...
#### Список 6 (20.09.2024)
* Добавлена возможность задавать псевдонимы колонок EXCEL, что устраняет необходимость их переименования. 
